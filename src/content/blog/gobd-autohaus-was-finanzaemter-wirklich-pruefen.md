...
Die GoBD nennt es explizit als unzulässig, wenn Buchungstapel bis zur Jahresabschlusserstellung offengehalten werden.
...
| Prüffeld | Was geprüft wird | Typisches Warnsignal | Sofortmaßnahme | Risiko |
| :--- | :--- | :--- | :--- | :--- |
| **Rechnungsnummern** | Lückenlosigkeit, Stornos | Fehlende Nummer, „manuelle“ Rechnungen | Nummernkreis-Report, Lücken aufklären | Hoch |
| **Bargeld/Kasse** | Kassensturzfähigkeit, Plausibilität | Kassen-Peaks, negativer Bestand, ungeklärte Einlagen | Tägliche Abschlüsse, Kassenbericht prüfen | Sehr Hoch |
